...
namespace ANN_Img_simple
{
    ...
    {
        //convert rgb to matrix[double]
        public static double[] ToMatrix
            (Bitmap BM, int MatrixRowNumber, int MatrixColumnNumber)
        {
        ...
        public static Bitmap ToImage(double[] Matrix, int MatrixRowNumber, int MatrixColumnNumber, int ImageHeight, int ImageWidth)
        {
